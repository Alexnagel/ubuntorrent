...
(/** @lends <global> */function( $ ) {
	...
	var DataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			nForm.className 	 = 'form-horizontal';
			var nFormGroup 		 = document.createElement( 'div' );
			nFormGroup.className = 'form-group';

			var nFilter 			= document.createElement( 'div' );
			nFilter.className 		= oSettings.oClasses.sFilter;
			nFilter.innerHTML 		= '<label class="control-label col-md-3">'+sSearchStr+'</label>\n<div class="col-md-8"><input type="text" class="form-control input-sm" /></div>';
			nFormGroup.innerHTML 	= nFilter.outerHTML;
